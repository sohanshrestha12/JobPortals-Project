        ...
        <div class="container">
            <div class="row justify-content-center mt-5 mb-5">
                <div class="col-md-3 d-flex justify-content-center align-items-center UserCompanyProfileImglogo">
                    ...
                    @else
                        <img style="height:200px;width:200px;" src="{{ asset('storage/Company Logo/' . $Cid->ProfileImg) }}" alt="404 image not found">
                    @endif
                </div>
            </div>
            <div class="row mb-1">
                        ...
                        <div style="margin-top:10px">
                            <div class="box1 d-flex bg-white shadow-sm align-items-center justify-content-between"
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="icon-sec d-flex align-items-center">
                                        @if ($jobs->company->ProfileImg == 'defaultImg.png')
                                            <img src="../img/job-icon1.png" alt=""
                                                style="object-fit: cover;border-radius:50%;width:50px;">
                                        @else
                                    ...
                                    <div class="text-sec" style="margin-left:10px!important">
                                        <a style="text-decoration: none" href="{{ url('JobProfile/' . $jobs->id) }}">
                                            <h4 style="font-size:1.4rem;letter-spacing:1px;font-weight:bold">
                                                {{ ucfirst($jobs->Title) }}</h4>
                                        </a>
                                        <div class="Jobiconprofile">
                                            <p style="font-size:0.8rem;margin:0">{{ 'Rs. ' . $jobs->Salary }}</p>
                                        </div>
                                        <div style="font-size:1.2rem;">
                                            <p style="font-size:1rem;margin:0">{{ $jobs->Skills }}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="UserCompany_view">
                                    ...
                                    <div style="margin-top: 10px;">
                                        <a style="background-color:#ff6158;border-radius:20px;padding:0.5rem 1.4rem;color:white;margin:0;text-decoration:none" href="{{ Route('adminJobs')}}">View Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
