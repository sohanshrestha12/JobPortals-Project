        ...
        <div class="row justify-content-center align-content-center" style="height: 80vh">
            <div class="col-md-4 overflow-hidden shadow bg-white rounded p-4">
                <form action="">
                    ...
                    <hr style="margin-bottom:20px;background-color: rgb(171, 171, 171)!important;height: 0.7px;border:none;opacity: 0.5;margin-left: -15px;width: 511px;">
                    <p class="paragraph">Plese enter your email to search for your account.</p>
                    <input type="email" placeholder="Enter Your Email">
                    <hr style="margin-bottom:20px;margin-top:25px;background-color: rgb(171, 171, 171)!important;height: 0.7px;border:none;opacity: 0.5;margin-left: -15px;width: 511px;">
