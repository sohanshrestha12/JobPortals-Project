                    ...
                    <div class="form-one-line">
                        <div class="company-form-grp" style="flex: 1;">
                            ...
                            <select class="category form-select @error('jobCategory') is-invalid @enderror"
                                ...
                                <option @if (old('jobCategory') == 'Accounting & Consulting') selected @endif value="Accounting & Consulting">
                                    Accounting and Consulting</option>
                                <option @if (old('jobCategory') == 'Admin Support') selected @endif value="Admin Support">Admin
                                    Support</option>
                                <option @if (old('jobCategory') == 'Customer Service') selected @endif value="Customer Service">Customer
                                    Service</option>
                                <option @if (old('jobCategory') == 'Data Science & Analysis') selected @endif value="Data Science & Analysis">
                                    Data Science and Analysis</option>
                                <option @if (old('jobCategory') == 'Design & Creative') selected @endif value="Design & Creative">Design
                                    and Creative</option>
                                ...
                                <option @if (old('jobCategory') == 'Sales & Marketing') selected @endif value="Sales & Marketing">Sales
                                    and Marketing</option>
                                <option @if (old('jobCategory') == 'Translation') selected @endif value="Translation">Translation
                                </option>
                    ...
                    <div class="form-one-line">
                        <div class="company-form-grp" style="flex: 1;">
                            ...
                            <select name="EducationDegree" class="category form-select  @error('EducationDegree') is-invalid @enderror">
                                ...
                                <option  @if (old('EducationDegree') == 'High school passout') selected @endif value="High school passout">High school passout</option>
                                <option  @if (old('EducationDegree') == 'Bachelor Degree') selected @endif value="Bachelor Degree">Bachelor Degree</option>
                                <option  @if (old('EducationDegree') == 'Master Degree') selected @endif value="Master Degree">Master Degree</option>
                                <option  @if (old('EducationDegree') == 'Doctoral Degree') selected @endif value="Doctoral Degree">Doctoral Degree</option>
                                <option  @if (old('EducationDegree') == 'None required') selected @endif value="None required">None required</option>
                            </select>
