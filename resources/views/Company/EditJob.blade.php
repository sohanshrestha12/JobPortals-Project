...
<div class="profile-right-box">
    ...
    <div class="row" style="padding: 0 8rem">
        <div class="col-md-8 shadow rounded" style="background-color: rgb(252, 252, 252);padding:1rem 0.5rem">
            <form action="{{ route('JobEdit') }}" method="post" style="
    ...
    ">
                ...
                <div class="company-form-grp">
                    ...
                    <input type="text" class="form-control @error('jobTitle') is-invalid @enderror" name="jobTitle" value="{{ $value->Title }}">
                    @error('jobTitle')
                ...
                <div class="form-one-line">
                    <div class="company-form-grp" style="flex: 1;">
                        ...
                        <select class="category form-select @error('jobCategory') is-invalid @enderror" name="jobCategory">
                    ...
                    <div class="company-form-grp" style="flex: 1">
                        ...
                        <input type="date" class="form-control @error('expiredDate') is-invalid @enderror" name="expiredDate" class="form-control" value="{{ $value->ExpiryDate }}">
                        @error('expiredDate')
                        <span class="invalid-feedback" style="font-size:1.3rem;padding-left:1rem;">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-one-line">
                    <div class="company-form-grp" style="flex: 1;">
                        ...
                        <textarea name="jobDescription" class="form-control @error('jobDescription') is-invalid @enderror" style="resize: vertical;">{{ $value->Description }}</textarea>
                ...
                <div class="form-one-line">
                    <div class="company-form-grp" style="flex: 1;">
                        ...
                        <textarea name="requiredSkills" style="resize: vertical;" class="form-control @error('requiredSkills') is-invalid @enderror">{{ $value->Skills }}</textarea>
                    ...
                    <div class="company-form-grp" style="flex: 1;">
                        ...
                        <select class="form-select category @error('experience') is-invalid @enderror" name="experience">
                ...
                <div class="form-one-line">
                    <div class="company-form-grp" style="flex: 1;">
                        ...
                        <select name="EducationDegree" class="category form-select  @error('EducationDegree') is-invalid @enderror">
                    ...
                    <div class="company-form-grp" style="flex: 1;">
                        ...
                        <input type="text" name="Education" class="form-control  @error('Education') is-invalid @enderror" placeholder="eg: BIT,BIM,etc" value="{{$value->Education}}">
                        @error('Education')
                        <span class="invalid-feedback" style="font-size:1.3rem;padding-left:1rem;">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-one-line">
                    <div class="company-form-grp" style="flex: 1;">
                        ...
                        <input type="text" name="salary" class="form-control @error('salary') is-invalid @enderror" value="{{ $value->Salary }}">
                        @error('salary')
                        <span class="invalid-feedback" style="font-size:1.3rem;padding-left:1rem;">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="company-form-grp" style="display: flex;justify-content:flex-end;gap:1.5rem;align-items:center;margin-top:1rem">
                    <a href="{{ route('ListofAllJobs') }}" style="text-decoration: none;background-color:#ff6158;padding:0.7rem 1.1rem;font-size:1.4rem;height:36px;color:white;border-radius:5px">Cancel</a>
