        ...
        <div class="main1  font_family">
            <div class="right col ">
                ...
                <div class="form_box font_size" style="padding: 0 65px;">
                    ...
                    <form class="shadow-sm p-4 mb-5 bg-white rounded" action="{{ route('UpdateJobSeekerInformation') }}"
                        method="post">
                        @csrf
                            ...
                            <div class="mb-3 d-flex w-100 ">
                                <div class="mb-3 " style="width: 50%;">
                                    ...
                                    <select class=" Exp category form-select @error('Industry') is-invalid @enderror"
                                        ...
                                        <option @if ($data->Industry == 'Admin Support') selected @endif value="Admin Support">
                                            Admin
                                            Support</option>
                ...
                <div class="botton text-center">
                    <button type="submit" style="margin-bottom:60px"
                        class="btn btn-warning btn-lg step_btn">Submit</button>
                </div>
                </form>
