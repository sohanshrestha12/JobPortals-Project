    ...
    <div class="profile-right-box">
        <div class="container" style="padding: 0 4rem">
            <div class="row">
                ...
                <div class="col-md-3 flex-column align-items-center mt" style="gap: 3rem">
                    ...
                    <div class="update-company-photo shadow">
                        ...
                        <form action="UpdateProfilePicture" enctype="multipart/form-data" method="POST"
                    ...
                    <div class="company-information shadow mt-4">
                        <h2 class="header2" style="color:black">Skills</h2>
                        <hr style="height: 3px;width:90%;color: black !important;margin: 0.2rem 0 1rem 0;opacity:1;">
                        <div class="company-information-details">
                            <div class="mt-2 d-flex flex-column" style="padding-left: 2rem;flex-wrap:wrap">
                       
                                <p class="paragraph"><b class="paragraph"></b> {{ ' ' . $data->Skills }}</p>
                ...
                <div class="col-md-6 d-flex justify-content-center">
                    <div class="company-update-information shadow">
                        <h2 class="header2">Update Your Information</h2>
                        <hr style="height: 3px;width:90%;color: black !important;margin: 0.2rem 0 1rem 0;opacity:1;">
                        <form action="UpdateJobSeekerInformation" method="post">
                            @csrf
                            <input type="hidden" name="id" value="{{ $data->id }}">
                            ...
                            <div class="company-form-grp">
                                ...
                                <textarea name="AboutMe" rows="5">@if ($data->AboutMe == '') {{'Write about yourself'}} @else {{ $data->AboutMe }} @endif</textarea>
                            </div>
                ...
                <div class="col-md-3 mb-3 justify-content-center">
                    <div class="company-information shadow">
                        <h2 class="header2" style="color:black">Details</h2>
                        <hr style="height: 3px;width:90%;color: black !important;margin: 0.2rem 0 1rem 0;opacity:1;">
                        <div class="company-information-details">
                            <div class="mt-2 d-flex flex-column" style="padding-left: 2rem;flex-wrap:wrap">
                                <p class="paragraph"><b class="paragraph">Full Name:</b> {{ ' ' . $data->name }}</p>
                                <p class="paragraph"><b class="paragraph">Profession:</b>{{ ' ' . $data->category }}
                                </p>
                    ...
                    <div class="company-information shadow mt-4">
                        <h2 class="header2" style="color:black">About Me</h2>
                        <hr style="height: 3px;width:90%;color: black !important;margin: 0.2rem 0 1rem 0;opacity:1;">
                        <div class="company-information-details">
                            <div class="mt-2 d-flex flex-column" style="padding-left: 2rem;flex-wrap:wrap">
                       
                                <p class="paragraph"><b class="paragraph"></b> {{ ' ' . $data->AboutMe }}</p>
