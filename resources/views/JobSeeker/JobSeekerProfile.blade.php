                        ...
                        <form action="{{ route('UpdateProfilePicture') }}" enctype="multipart/form-data" method="post"
                            ...
                            <div class="choose_pic">
                                ...
                                <input type="file" accept="image/x-png,image/gif,image/jpeg"
                                    style="width: 13px;height: 13px;border-radius: 50%; display:none" id="change"
                                    name="logo">
                ...
                <div class="body_partition row ">
                    <div class="left_part col">
                        ...
                        <div class="Contact_details font font_size ">
                            <ul>
                                <li><i class="uil uil-phone-volume"></i>{{ $data->phoneno }}</li>
                                <li><i class="uil uil-envelope-check"></i>{{ $data->email }}</li>
                                <li><i class="uil uil-location-pin-alt"></i>{{ $data->city }}</li>
